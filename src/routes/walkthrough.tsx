      ...
      <main>
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(160deg, rgba(32, 60, 127,0.85) 0%, rgba(32, 60, 127,0.7) 50%, rgba(32, 60, 127,0.95) 100%)",
            }}
            aria-hidden="true"
          />
          ...
          <div className="relative arch-container">
            <p className="arch-label mb-4" style={{ color: "var(--highlight)" }}>01 / WALKTHROUGH</p>
              ...
              <FadeUp delay={0.15}>
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(180deg, rgba(32, 60, 127,0.1) 0%, transparent 40%, rgba(32, 60, 127,0.4) 100%)",
                    }}
                  />
