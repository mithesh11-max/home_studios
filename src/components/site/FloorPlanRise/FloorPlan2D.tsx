      ...
      <div className="sticky top-0 h-screen w-full flex flex-col justify-between items-center overflow-hidden px-4 py-8">
        ...
        <div className="relative z-20 w-full max-w-6xl mx-auto pt-16 flex justify-between items-start pointer-events-none">
          <div>
            ...
            <h2 className="font-display text-primary text-[clamp(1.5rem,3.2vw,2.4rem)] font-light leading-none">
              From drawing to physical space.
            </h2>
          </div>

          {/* Signature Phase HUD Pill */}
          <div className="flex items-center gap-1.5 sm:gap-2 px-3 py-1.5 border border-rule/40 bg-deep/80 backdrop-blur-sm font-mono text-[9px] tracking-widest uppercase">
            <span
        ...
        <div
          className="relative w-full max-w-[880px] aspect-[16/10] sm:aspect-[16/9] bg-surface border border-indigo/15 overflow-hidden my-auto"
        ...
        >
          ...
          >
            ...
            >
              ...
              {/* Dimension Callouts */}
              <text x="300" y="60" textAnchor="middle" fill="#3E5A8D" fontSize="9" fontFamily="monospace" letterSpacing="1">
                7.40 M
              </text>
              <text x="445" y="180" fill="#3E5A8D" fontSize="9" fontFamily="monospace" letterSpacing="1">
                6.00 M
              </text>
              <text x="300" y="185" fill="#203C7F" fontSize="11" fontFamily="Sprat" fontWeight="500" textAnchor="middle">
                DOUBLE-HEIGHT LIVING
              </text>
              <text x="120" y="200" fill="#3E5A8D" fontSize="9" fontFamily="Sprat" textAnchor="middle">
                SUITE / 4.2M
              </text>
              <text x="480" y="180" fill="#3E5A8D" fontSize="9" fontFamily="Sprat" textAnchor="middle">
                DINING / 3.8M
              </text>
            </svg>

            <div className="flex justify-between items-end text-[9px] font-mono tracking-widest text-stone border-t border-indigo/15 pt-2">
          ...
          >
            ...
            >
              ...
              <rect x="220" y="140" width="160" height="110" fill="rgba(32, 60, 127, 0.08)" stroke="#203C7F" strokeWidth="0.8" strokeDasharray="3 3" />
              {/* Sectional Sofa */}
              <rect x="240" y="210" width="120" height="30" fill="#B1D0CB" stroke="#203C7F" strokeWidth="1.2" />
              <rect x="240" y="170" width="35" height="40" fill="#B1D0CB" stroke="#203C7F" strokeWidth="1.2" />
              {/* Coffee Table */}
              <rect x="270" y="170" width="60" height="25" fill="#98BFCB" stroke="#3E5A8D" strokeWidth="1" />
              {/* Kitchen Island */}
              <rect x="450" y="150" width="40" height="70" fill="#B1D0CB" stroke="#203C7F" strokeWidth="1.2" />
              {/* Master Bed */}
              <rect x="90" y="160" width="60" height="70" fill="#98BFCB" stroke="#203C7F" strokeWidth="1.2" />

              <text x="300" y="160" fill="#203C7F" fontSize="9" fontFamily="monospace" textAnchor="middle">
                FURNITURE CLEARANCE: 1200MM
              </text>
            </motion.svg>

            <div className="flex justify-between text-[9px] font-mono tracking-widest text-stone border-t border-indigo/15 pt-2">
          ...
          >
            ...
            <div
              ...
              style={{
                background: "linear-gradient(180deg, rgba(32, 60, 127,0.15) 0%, rgba(32, 60, 127,0.7) 100%)",
              }}
            />
            ...
            >
              <div className="flex justify-between items-start">
                <span className="px-2 py-1 bg-deep/85 border border-indigo/20 font-mono text-[9px] text-primary">
                  3.60M CEILING HEIGHT
                </span>
                <span className="px-2 py-1 bg-deep/85 border border-indigo/20 font-mono text-[9px] text-indigo">
                  NATURAL CROSS-VENTILATION
                </span>
              </div>

              <div className="flex justify-between items-end">
                <span className="px-2 py-1 bg-deep/85 border border-indigo/20 font-mono text-[9px] text-primary/85">
          ...
          <div className="absolute top-2 left-2 w-2 h-2 border-t border-l border-indigo/30 pointer-events-none z-30" />
          <div className="absolute top-2 right-2 w-2 h-2 border-t border-r border-indigo/30 pointer-events-none z-30" />
          <div className="absolute bottom-2 left-2 w-2 h-2 border-b border-l border-indigo/30 pointer-events-none z-30" />
          <div className="absolute bottom-2 right-2 w-2 h-2 border-b border-r border-indigo/30 pointer-events-none z-30" />
        </div>
        ...
        >
          <h3 className="font-display text-primary text-[clamp(1.4rem,3vw,2.2rem)] font-light mb-2 leading-tight">
            SEE THE SPACE BEFORE IT EXISTS.
          </h3>
          <p className="text-secondary text-[0.92rem] max-w-[44ch] mx-auto mb-4 leading-relaxed">
